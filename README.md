...
### `Communications`
The needed information for/about communication department.
* #### 1- Accounts Deletion: View Accounts Deletion data
* #### 2- Generate Promo Code: Promo Code
### `QA`
The needed information for/about QA.
* #### 1- Change Status: user status Date
* #### 2- Website: user email subscription status
### `Developer`
The needed information for/about developers.
* #### 1- Flagged Connections: to get Flagged Connections Dashboard
* #### 2- On Call Team: 
  * On Call Team (Update)
  * Add On Call Team Member
  * Delete On Call Team Member
* #### 3- On Call: to get On Call Dashboard
* #### 4- VIP Issues: search User Latest Receipt using userID & platform
* #### 5- Watch Alerts: get Watch Alert Dashboard in line Graphs for:
  * User
  * Users Login
  * Users Payments
